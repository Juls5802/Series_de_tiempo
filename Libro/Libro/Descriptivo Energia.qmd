...
En la @fig-periodorginenerg se presenta el periodograma para la serie original, el valor del periodo donde se maximiza el periodograma es $182.86$, es decir, aproximadamente, el ciclo es de medio año.
...
plot.ts(sin_est, main="Serie diferenciada", ylab='')
```
...
plot(energia2-results_ciclo_ts1)
```
